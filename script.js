const prices = [
  ["Fridge freezer", "From £229", "Sourcing guide. Final quote depends on brand, size, finish, condition, and quality."],
  ["Electric cooker", "From £179", "Sourcing guide. Final quote depends on brand, condition, and electrical requirements."],
  ["Washing machine", "From £179", "Sourcing guide. Final quote depends on brand, drum size, condition, and quality."],
  ["Dryer", "From £144", "Sourcing guide. Final quote depends on brand, type, condition, and ventilation requirements."],
  ["Washing machine and dryer bundle", "From £389", "Sourcing guide for standard used units. Higher-quality brands may cost more."],
  ["Dishwasher", "From £109", "Sourcing guide. Final quote depends on brand, condition, and installation requirements."],
  ["Microwave", "From £89", "Countertop sourcing guide. Combination and over-hob requests may cost more."],
  ["Studio serviced apartment appliance pack", "From £799", "Sourcing guide for compact serviced apartments, studios, and short-stay units."],
  ["Landlord turnover set", "From £1,299", "Sourcing guide. Bundle savings available. Final quote depends on selected appliance brands and quality tier."],
